...
import com.overknighters.application.eventhub.app.AppController;
import com.overknighters.application.eventhub.app.URL;
import com.overknighters.application.eventhub.helper.Util;
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    user_count=Integer.valueOf(json.getString("user_count"));
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if(json.getString("success").equalsIgnoreCase("1"))
                    {
                        ...
                        user_count++;
                        eventPeople.setText(String.valueOf(user_count)+" Going");
                    }
